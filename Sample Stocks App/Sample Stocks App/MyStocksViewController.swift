...
private extension MyStocksViewController {
    ...
    func getHistoricaldataFor6Months(_ symbol: String , completionBlock: @escaping (Data) -> Void) -> Void
        {

            let requestURL = historicalStatsUrl(symbol)
    ...
    func historicalStatsUrl(_ symbol: String) -> URL? {
        let path = "https://finnhub.io/api/v1/stock/candle?" + "symbol=" + symbol + "&resolution=1&from=1693493346&to=1693752546&token=cjf5olhr01qhblojnrb0cjf5olhr01qhblojnrbg"
...
//        let swiftUIView = StockPictureViewController(symbol: item.symbol!, dataPrices: sample, maxY: 0, minY: 0)
//
