...
//        if let url = historicalStatsUrl(symbol) {
//            group.enter()
//            url.get { (h: [HistoricalStat]?) in
//                hs = h
//                group.leave()
//            }
//        }
...
private extension Finnhub {
    ...
    static let apiKey = "cjf5olhr01qhblojnrb0cjf5olhr01qhblojnrbg"

    static let host = "finnhub.io"
    static let baseUrl = "/api/v1"

    enum Endpoint: String {
        case companyNews, dividend, executive, profile2, quote, symbol, historicalStats
// return "\(baseUrl)/company-news" line 184
        var path: String {
            switch self {
            case .companyNews:
               return "\(baseUrl)/stock/candle?"
            case .quote:
...
//https://finnhub.io/api/v1/stock/candle?symbol=AAPL&resolution=1&from=1693493346&to=1693752546&token=cjf5olhr01qhblojnrb0cjf5olhr01qhblojnrbg
...
private extension Finnhub {
    ...
    static func historicalStatsUrl(_ symbol: String) -> URL? {
//        var path = Endpoint.historicalStats.path + "symbol=" + symbol + "&resolution=1&from=1693493346&to=1693752546&token=cjf5olhr01qhblojnrb0cjf5olhr01qhblojnrbg"
        return url(path: Endpoint.historicalStats.path, symbol: symbol)
    }
//https://finnhub.io/api/v1/stock/candle?symbol=AAPL&resolution=1&from=1693493346&to=1693752546&token=cjf5olhr01qhblojnrb0cjf5olhr01qhblojnrbg
